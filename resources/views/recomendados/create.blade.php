...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">CREAR NUEVOS LUGARES RECOMENDADOS</h1>

    <form class="mt-4"  action="/recomendados" method="POST" enctype="multipart/form-data">
        ...
        id="lugar_recomendado" name="lugar_recomendado">
        ...
        id="resenahistorica" name="resenahistorica">
