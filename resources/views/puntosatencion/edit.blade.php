...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="/puntosatencion/{{$punto->id}}" method="POST" enctype="multipart/form-data">
        ...
        id="mombre_puntoatencion" name="mombre_puntoatencion" value="{{$punto->nombre_puntoatencion}}">
