...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">CREAR NUEVA RUTA DE ACCESO </h1>

    <form class="mt-4"  action="/rutasacceso" method="POST" enctype="multipart/form-data">
        ...
        id="empresa_transporte" name="empresa_transporte">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicacion" name="mun_ubicacion">
       ...
       Apertura del servicio:
        ...
        id="inicio_atencion" name="inicio_atencion">
       ...
       Fin del servicio:
        <input type="time" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="cierre_atencion" name="cierre_atencion">
     ...
     Número de contacto:
      ...
      Correo electrónico:
      <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
      id="correo_empresa" name="correo_empresa">
