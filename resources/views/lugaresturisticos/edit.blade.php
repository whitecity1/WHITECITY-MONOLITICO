...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">CREAR NUEVO LUGAR</h1>

    <form class="mt-4"  action="/lugaresturisticos/{{$lugar->id}}" method="POST" enctype="multipart/form-data">
        ...
        id="lugar_turistico" name="lugar_turistico" value="{{$lugar->lugar_turistico}}">
        ...
        id="horario_apertura" name="horario_apertura" value="{{$lugar->horario_apertura}}">
        @error('horario_apertura')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        Horario cierre atención:
        <input type="time" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="horario cierre" name="horario_cierre" value="{{$lugar->horario_cierre}}">
        ...
        Municipio:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="municipio" name="municipio" value="{{$lugar->municipio}}">
        @error('municipio')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        ...
        Dirección:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="direccion" name="direccion" value="{{$lugar->direccion}}">
        @error('direccion')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$lugar->telefono}}">
        @error('horario_apertura')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        Correo  electrónico:
        ...
        id="correo_electronico" name="correo_electronico" value="{{$lugar->correo_electronico}}">
        ...
        Detalles:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="detalles" name="detalles" value="{{$lugar->detalles}}">
        @error('detalles')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="tipo_lugar" name="tipo_lugar" value="{{$lugar->tipo_lugar}}">
        @error('tipo_lugar')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
