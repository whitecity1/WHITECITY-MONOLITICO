...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">EDITAR SERVICIO </h1>

    <form class="mt-4"  action="/autoridades/{{$autoridad->id}}" method="POST" enctype="multipart/form-data">
        ...
        id="nombre_autoridad" name="nombre_autoridad" value="{{$autoridad->nombre_entidad}}">

        @error('nombre_autoridad')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$autoridad->telefono}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$autoridad->correoelec}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$autoridad->mun_ubicado}}">
        ...
        id="direccion" name="direccion" value="{{$autoridad->direccion}}">
        ...
        id="apertura" name="apertura" value="{{$autoridad->apertura}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$autoridad->cierre}}">
...
<!--Para que se mire la imagen antes de subirla-->
 ...
 $('#imagen').change(function() {
     ...
     reader.readAsDataURL(this.files[0]);
        ...
        <a href="/listarautoridades" class="btn btn-secondary" tabindex="5">Cancelar</a>
