...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">EDITAR PUNTO ATENCION </h1>

    <form class="mt-4"  action="/estacioneservicio/{{$estacion->id}}" method="POST" enctype="multipart/form-data">
        ...
        id="estacion_servicio" name="mombre_puntoatencion" value="{{$punto->estacion_servicio}}">

        @error('mombre_puntoatencion')
        <p class="border border-red-500 rouded-md bg-red-100 w-full text-red-600 p-2 my-2">{{$message}}</p>    
        @enderror
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$punto->telefono}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$punto->correo}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$punto->mun_ubicado}}">
        ...
        id="direccion" name="direccion" value="{{$punto->direccion}}">
        ...
        id="apertura" name="apertura" value="{{$punto->apertura}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$punto->cierre}}">
