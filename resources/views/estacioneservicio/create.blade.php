...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="/estacioneservicio" method="POST" enctype="multipart/form-data">
        ...
        id="estacion_servicio" name="estacion_servicio">
...
<!--Para que se mire la imagen antes de subirla-->
        ...
        <a href="/listarestacioneservicio"  class="btn btn-secondary" tabindex="5">Cancelar</a>
