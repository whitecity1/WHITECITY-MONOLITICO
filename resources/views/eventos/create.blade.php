...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <h1 class="text-3xl text-center pt-24 font-bold">CREAR NUEVOS EVENTOS</h1>

    <form class="mt-4"  action="/eventos" method="POST" enctype="multipart/form-data">
...
<!--Para que se mire la imagen antes de subirla-->
        ...
        <a href="/listareventos" class="btn btn-secondary" tabindex="5">Cancelar</a>
