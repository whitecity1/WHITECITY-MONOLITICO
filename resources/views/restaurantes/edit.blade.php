...
<div class="block mx-auto my-12 p-8 bg-white w-1/2 border border-gray-200 rounded-lg shadow-lg">
    ...
    <form class="mt-4"  action="/restaurantes/{{$restaurante->id}}" method="POST" enctype="multipart/form-data">
        ...
        id="restauante" name="restaurante" value="{{$restaurante->restaurante}}">
        ...
        Telefono:
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="telefono" name="telefono" value="{{$restaurante->telefono}}">
       ...
       Correo Electrónico:
        ...
        id="correo" name="correo" value="{{$restaurante->correo}}">
        ...
        <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder=""
        id="mun_ubicado" name="mun_ubicado" value="{{$restaurante->mun_ubicado}}">
        ...
        id="direccion" name="direccion" value="{{$restaurante->direccion}}">
        ...
        id="apertura" name="apertura" value="{{$restaurante->apertura}}">
       ...
       Fin de la atención:
        ...
        id="cierre" name="cierre" value="{{$restaurante->cierre}}">
...
<!--Para que se mire la imagen antes de subirla-->
 ...
 $('#imagen').change(function() {
     ...
     reader.readAsDataURL(this.files[0]);
        ...
        <a href="/listarservicios" class="btn btn-secondary" tabindex="5">Cancelar</a>
